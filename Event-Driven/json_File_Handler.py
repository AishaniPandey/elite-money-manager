...
class json_File_Handler(): 
    ...
    @staticmethod
    def get_instance():
        if json_File_Handler._instance is None:
            json_File_Handler._instance = json_File_Handler()
        return json_File_Handler._instance
    ...
    def append_To_File(self, file_path, new_data):
        ...
        try:
            ...
            with LockFile(file_path, timeout=20):
