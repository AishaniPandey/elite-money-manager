...
import kivy_PaymentLogger.src.paymentdb
from kivy_PaymentLogger.src.util.json_File_Handler import json_File_Handler
from abc import ABC, abstractmethod
from kivy_PaymentLogger.src.util.KafkaHandler import KafkaHandler
...
class UpdateSQLiteCommand(Command):
    def __init__(self, data):
        self.data = data
        self.db = kivy_PaymentLogger.src.paymentdb.PaymentDB()
