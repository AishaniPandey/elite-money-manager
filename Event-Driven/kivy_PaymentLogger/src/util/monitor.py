...
KAFKA_TOPIC_NAMES = ["monitor-authentication", "monitor-budget-manager", "monitor-data-view", "monitor-feedback-support", "monitor-monitoring", "monitor-notification", "monitor-payment-logger", "monitor-test"]
            ...
            while (True):
                ...
                if os.path.exists("./monitoring/alerted_Monitoring.json"):
                    ...
                    for entry in remove_From_Alert_Monitoring:
                        ...
                        notify.send_Notification("yashsampat23154@gmail.com", "ERROR in subsystem", f'{entry["subsystem_Name"]} is not working properly. Kindly take some action to ensure proper functioning of the application.')

                    

                else:
                    print("File not found: ./monitoring/alerted_Monitoring.json")
        ...
        try : 
            ...
            while (True):
                ...
                if os.path.exists("./monitoring/standard_Monitoring.json"):
                    ...
                    print("File not found: ./monitoring/standard_Monitoring.json")
